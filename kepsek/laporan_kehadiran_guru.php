<?php
/*
File: kepsek/laporan_kehadiran_guru.php
Deskripsi: Laporan Kehadiran Guru untuk Kepala Sekolah (Read Only)
*/
    ...
    <div class="row mb-4">
        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card border-left-danger h-100">
                <div class="card-body">
                    <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Total Ketidakhadiran</div>
                    <div class="h5 mb-0 font-weight-bold"><?= $statistik['total_ketidakhadiran'] ?></div>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card border-left-warning h-100">
                <div class="card-body">
                    <div class="text-xs font-weight-bold text-uppercase mb-1">Sakit</div>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card border-left-info h-100">
                <div class="card-body">
                    <div class="text-xs font-weight-bold text-uppercase mb-1">Izin</div>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card border-left-secondary h-100">
                <div class="card-body">
                    <div class="text-xs font-weight-bold text-uppercase mb-1">Cuti</div>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card border-left-primary h-100">
                <div class="card-body">
                    <div class="text-xs font-weight-bold text-uppercase mb-1">Guru Terdampak</div>
