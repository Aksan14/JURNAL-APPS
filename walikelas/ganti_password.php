<?php
/*
File: walikelas/ganti_password.php
Ganti Password Wali Kelas
*/
...
if (isset($_POST['change_pwd'])) {
    ...
    if (!$user) {
    ...
    } elseif (!password_verify($pass_lama, $user['password_hash'])) {
        ...
        $message = "<div class='alert alert-success'><i class='fas fa-check-circle me-2'></i>Password berhasil diperbarui!</div>";
    }
}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card bg-light shadow mb-4">
                <div class="card-body">
                    <h5><i class="fas fa-shield-alt text-success"></i> Tips Keamanan:</h5>
                    <ul class="mt-3">
                        <li>Jangan gunakan password yang mudah ditebak.</li>
                        <li>Gunakan kombinasi huruf, angka, dan simbol.</li>
                        <li>Jangan berikan akun/password Anda kepada orang lain.</li>
                        <li>Ganti password secara berkala untuk menjaga keamanan data.</li>
                    </ul>
                </div>
            </div>
        </div>
